...
# Input fields with min and max values shown in the label
nitrogen = st.number_input("Nitrogen Content (N) [Range: 0-300 kg/ha]:", min_value=0.0, max_value=300.0, step=0.1)
phosphorus = st.number_input("Phosphorus Content (P) [Range: 0-150 kg/ha]:", min_value=0.0, max_value=150.0, step=0.1)
potassium = st.number_input("Potassium Content (K) [Range: 0-800 kg/ha]:", min_value=0.0, max_value=800.0, step=0.1)
temperature = st.number_input("Temperature (°C) [Range: -5 to 50]:", min_value=-5.0, max_value=50.0, step=0.1)
humidity = st.number_input("Humidity (%) [Range: 20-100]:", min_value=20.0, max_value=100.0, step=0.1)
ph = st.number_input("Soil pH Level [Range: 4.0-9.0]:", min_value=4.0, max_value=9.0, step=0.1)
rainfall = st.number_input("Rainfall (mm) [Range: 0-3000]:", min_value=0.0, max_value=3000.0, step=0.1)
